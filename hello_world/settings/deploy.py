...
if 'DATABASE_URL' in os.environ:
    ...
    DATABASES['default']['NAME'] = 'hello_world_%s' % ENVIRONMENT.lower()
    DATABASES['default']['USER'] = 'hello_world_%s' % ENVIRONMENT.lower()
    DATABASES['default']['HOST'] = os.environ.get('DB_HOST', '')
    DATABASES['default']['PORT'] = os.environ.get('DB_PORT', '')
    DATABASES['default']['PASSWORD'] = os.environ.get('DB_PASSWORD', '')

    WEBSERVER_ROOT = '/var/www/hello_world/'
...
EMAIL_SUBJECT_PREFIX = '[Hello_World %s] ' % ENVIRONMENT.title()
...
# BROKER_URL = 'amqp://hello_world_%(ENVIRONMENT)s:%(BROKER_PASSWORD)s@%(BROKER_HOST)s/hello_world_%(ENVIRONMENT)s' % os.environ  # noqa
