...
var options = {
  src: './hello_world/static/js/index.js',
  dest: './hello_world/static/js/',

  modernizr: {
    src: './hello_world/static/js/index.js',
    dest: './hello_world/static/libs/',
  },

  css: {
    src: './hello_world/static/less/index.less',
    watch: './hello_world/static/less/**/*.less',
    dest: './hello_world/static/css/'
  },
  development: false
}
...
gulp.task('test', function () {
  ...
  return gulp
    .src('./hello_world/static/js/app/**/*.js')
    .pipe(istanbul({
    ...
    .on('finish', function () {
      gulp
        .src('./hello_world/static/js/test/**/test_*.js', {read: false})
        .pipe(mocha({
          require: [
